...
public class PlayQueueIntTest {


    private static String mixerName = "default [default]";

    @Test
    public void playSingle_WAV_16_44100() throws Exception {
        DataChannel dataChannel = new LocalDataChannel();
        ControlChannel controlChannel = new LocalControlChannel();
        PlayQueue queue = new PlayQueue();
        queue.bindControlChannel(controlChannel);
        queue.bindDataChannel(dataChannel);
        Player player = new Player(mixerName);
